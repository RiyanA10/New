  ...
  const onSubmit = async (data: PropertyFormValues) => {
    ...
    if (!isLandlord) {
      toast({
        ...
        description: "Only landlords can add properties. Your role appears to be: " + user?.displayName,
        variant: "destructive",
      });
      return;
    }
    ...
    try {
      ...
      await setDoc(newPropertyRef, {
        ...
        verified: false, // Add property verification status
        published: true, // Set initial published status
        images: images,
      ...
      toast({
        title: "Success",
        description: "Your property has been successfully added. Redirecting to properties list.",
      });

      // Redirect to properties index page using wouter's setLocation
      console.log("Redirecting to properties page");
      setLocation("/properties");
      // Logging the redirection for debugging
      console.log("Redirecting to properties page after successful property addition"); 
    } catch (error: any) {
